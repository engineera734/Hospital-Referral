...
export function MobileInfoCard({ title, subtitle, meta, status, footer, avatar, children }: any) {
  return (
    <article className="mb-3 rounded-[1.35rem] border border-slate-100 bg-slate-50 p-4">
